...
const roots = [
  ...
  "apps/operations-control/dist",
  "apps/provider-control/dist",
  "apps/recovery-control/dist",
  "apps/recovery-game-day/dist",
  "apps/recovery-verifier/dist",
...
const inspectProductionBundles = async (): Promise<void> => {
  ...
  await Promise.all([
    ...
    inspectForForbiddenAuthority("apps/recovery-verifier/dist", [
      "CLERK_SECRET_KEY",
      "DATABASE_URL",
      "HYPERDRIVE",
      "MIGRATION_DATABASE_URL",
